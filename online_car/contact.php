						...
						<div class="site-logo">
							<a href="index.php">
								<img src="assets/img/CARLOGO.png" width="65px" height="70px"  alt="">
						         ...
						         <!-- <img class="preloader" src="images/logo8.png" alt="#"> -->
						<!-- logo -->
		...
		<div class="container">
			...
			<?php
						...
						if (isset($_POST['submit'])) {
							...
							$insert="insert into tbl_contact(name,email,phone,subject,message ) value('$name','$email','$phone','$subject','$message')";
				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						...
						<p>please ask your questions related to your enquiry by filling 
						out your contact page</p>
					</div>
				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<p>kaloor,Ernakulam<br> kerala <br> India</p>
						</div>
						<div class="contact-form-box">
						...
						<div class="contact-form-box">
							...
							<p>Phone: +00 111 222 3333 <br> Email: support@tesla.com</p>
						</div>
					</div>
				</div>
			</div>
